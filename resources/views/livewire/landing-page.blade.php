<div>
    ...
    <section class="text-center py-20 px-4 bg-gradient-to-r from-blue-50 to-blue-100">
        <h2 class="text-4xl font-bold mb-2">Hi, Saya Arjun 👋</h2>
        <p class="text-lg text-gray-600 mb-6">Full Stack Software Engineer dengan fokus pada solusi efisien dan
            berskala.</p>
    ...
    <!-- Experience -->
    <section id="experience" class="py-16 max-w-4xl mx-auto px-4">
    ...
    <!-- Education -->
    <section id="education" class="py-16 max-w-4xl mx-auto px-4">
    ...
    <!-- Achievement -->
    <section id="achievements" class="py-16 max-w-4xl mx-auto px-4">
